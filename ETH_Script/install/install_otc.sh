#!/usr/bin/ksh
IB_DIR="/OTC/bin/OTC/HA_script"
IB_LOG="/OTC/IB_log"
IB_CFG="/OTC/cfg/OTC/HA_script"
#IB_MONI_DIR="/tmp/ib_script_moniter"
#IB_MONI_DIR_RS="${IB_MONI_DIR}/release"
IB_MONI_DIR="/OTC/bin"
HA_DIR="/home"
OTC_OWN="otc:otc"
EXADM_OWN="otcexadm:otcexc"
IB_SHELL="ib_start.sout ib_stop.sout "
HA_SHELL="startAP.sh stopAP.sh "
IB_MONI="ibsmon_np_client ibsmon_np"
IB_CFG_FILE="ib_start.cfg ib_stop.cfg "
#                       1        2           3
#set -A OTC_DIR_LIST $IB_DIR $IB_MONI_DIR $IB_MONI_DIR_RS $HA_DIR
set -A OTC_DIR_LIST $IB_DIR $IB_MONI_DIR $HA_DIR $IB_LOG
LOGDIR="/tmp"
