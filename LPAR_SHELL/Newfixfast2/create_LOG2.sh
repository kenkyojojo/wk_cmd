...
CLIENT_NAME="LOG2"     # Name of the partition --menual
...
CLIENT_MINMEM="6144"             # Minimum memory in megabyte
CLIENT_DESMEM="6144"             # Desired memory in megabyte
CLIENT_MAXMEM="12288"             # Maximum memory in megabyte
CLIENT_PMODE="shared"           # shared or ded
CLIENT_SMODE="cap"            # cap or uncap
CLIENT_SWEIGHT="128"            # Value between 0 and 255
CLIENT_MINPU="0.2"              # Min processing units
CLIENT_DESPU="0.2"              # Des processing units
...
CLIENT_VETH="2/0/101//0/0,3/0/102//0/0,4/0/4//0/0,5/0/5//0/0,6/0/6//0/0"       # Virtual Ethernet adapter
