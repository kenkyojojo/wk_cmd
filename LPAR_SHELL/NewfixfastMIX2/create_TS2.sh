...
CLIENT_NAME="TS2"     # Name of the partition --menual
...
CLIENT_MINMEM="3072"             # Minimum memory in megabyte
CLIENT_DESMEM="3072"             # Desired memory in megabyte
CLIENT_MAXMEM="6144"             # Maximum memory in megabyte
...
CLIENT_DESPU="0.3"              # Des processing units
CLIENT_MAXPU="1"              # Max processing units
CLIENT_MINVP="1"                # Min virtual CPU
CLIENT_DESVP="1"                # Des virtual CPU
CLIENT_MAXVP="1"                # Max virtual CPU
