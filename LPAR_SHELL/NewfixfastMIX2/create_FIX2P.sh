...
CLIENT_NAME="FIXGW02P"     # Name of the partition --menual
CLIENT_PROFILE="FIX_FAST" # Name of the profile --menual
CVIOS1="VIOS2-1"                # Name of the VIOS1   --menual 
CVIOS2="VIOS2-2"                # Name of the VIOS2   --menual
CLIENT_ENV="aixlinux"           # Operating environment
CLIENT_MINMEM="16384"             # Minimum memory in megabyte
CLIENT_DESMEM="32768"             # Desired memory in megabyte
...
CLIENT_DESPU="2"                # Min virtual CPU
