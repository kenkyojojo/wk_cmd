...
CLIENT_NAME="DAP1-"     # Name of the partition --menual
...
CLIENT_MINMEM="1536"             # Minimum memory in megabyte
...
CLIENT_VETH="2/0/102//0/0,3/0/2//0/0,4/0/4//0/0,5/0/5//0/0"       # Virtual Ethernet adapter
