...
CLIENT_NAME="QCTS"     # Name of the partition --menual
...
CLIENT_DESMEM="5120"             # Desired memory in megabyte
CLIENT_MAXMEM="5120"             # Maximum memory in megabyte
...
CLIENT_VETH="2/0/3//0/0,3/0/4//0/0,4/0/5//0/0,5/0/6//0/0"       # Virtual Ethernet adapter
