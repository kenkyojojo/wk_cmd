...
CLIENT_NAME="OTCMIS"     # Name of the partition --menual
...
CLIENT_VETH="4/0/4//0/0,5/0/5//0/0,6/0/6//0/0,7/0/9//0/0,8/0/10//0/0,9/0/42//0/0,10/0/101//0/0,11/0/102//0/0,12/0/134//0/0,13/0/2//0/0,14/0/55//0/0"       # Virtual Ethernet adapter
