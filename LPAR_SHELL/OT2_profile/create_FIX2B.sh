...
CLIENT_NAME="FIXGW02B"     # Name of the partition --menual
...
CLIENT_MINMEM="16384"             # Minimum memory in megabyte
...
CLIENT_DESVP="3"               # Des processing units
CLIENT_MAXVP="10"              # Max virtual CPU
CLIENT_VSLOT="200"               # Number of virtual slots
CLIENT_VETH="4/0/4//0/0,5/0/5//0/0,6/0/6//0/0,7/0/9//0/0,8/0/10//0/0,9/0/42//0/0,10/0/21//0/0,11/0/55//0/0"       # Virtual Ethernet adapter
