...
CLIENT_NAME="MIS"     # Name of the partition --menual
...
CLIENT_DESMEM="16384"             # Desired memory in megabyte
...
CLIENT_DESPU="2"              # Des processing units
CLIENT_MAXPU="4"              # Max processing units
...
CLIENT_VETH="4/0/4//0/0,5/0/5//0/0,6/0/6//0/0,7/0/9//0/0,8/0/10//0/0,9/0/42//0/0,10/0/101//0/0,11/0/102//0/0,12/0/34//0/0,13/0/3//0/0,14/0/55//0/0"       # Virtual Ethernet adapter
