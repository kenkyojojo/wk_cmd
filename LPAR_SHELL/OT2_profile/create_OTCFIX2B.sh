...
CLIENT_NAME="OTCFIXGW02B"     # Name of the partition --menual
...
CLIENT_MINMEM="12288"             # Minimum memory in megabyte
CLIENT_DESMEM="20480"             # Desired memory in megabyte
CLIENT_MAXMEM="36864"             # Maximum memory in megabyte
...
CLIENT_DESPU="0.5"                # Min virtual CPU
CLIENT_MAXPU="10"               # Max processing units 
CLIENT_MINVP="1"               # Des virtual CPU
CLIENT_DESVP="2"               # Des processing units
CLIENT_MAXVP="10"              # Max virtual CPU
CLIENT_VSLOT="200"               # Number of virtual slots
CLIENT_VETH="4/0/4//0/0,5/0/5//0/0,6/0/6//0/0,7/0/9//0/0,8/0/10//0/0,9/0/42//0/0,10/0/121//0/0,11/0/55//0/0"       # Virtual Ethernet adapter
...
"max_proc_units=$CLIENT_MAXPU","min_procs=$CLIENT_MINVP","desired_procs=$CLIENT_DESVP","max_procs=$CLIENT_MAXVP",\
