...
CLIENT_NAME="FIXGWY02P"     # Name of the partition --menual
CLIENT_PROFILE="FIXGWY" # Name of the profile --menual
CVIOS1="VIOS1Y"                # Name of the VIOS1   --menual 
CVIOS2="VIOS2Y"                # Name of the VIOS2   --menual
