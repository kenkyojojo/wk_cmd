...
CLIENT_NAME="MDS2Y"     # Name of the partition --menual
...
CLIENT_MAXPU="6"              # Max processing units
CLIENT_MINVP="1"                # Min virtual CPU
CLIENT_DESVP="1"                # Des virtual CPU
CLIENT_MAXVP="6"                # Max virtual CPU
CLIENT_VSLOT="200"               # Number of virtual slots
CLIENT_VETH="2/0/101//0/0,3/0/4//0/0,4/0/5//0/0"       # Virtual Ethernet adapter
