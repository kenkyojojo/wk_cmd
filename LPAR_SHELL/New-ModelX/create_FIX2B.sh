...
CLIENT_NAME="FIXGWX02B"     # Name of the partition --menual
CLIENT_PROFILE="FIXGWX" # Name of the profile --menual
CVIOS1="VIOS1X"                # Name of the VIOS1   --menual 
CVIOS2="VIOS2X"                # Name of the VIOS2   --menual
CLIENT_ENV="aixlinux"           # Operating environment
CLIENT_MINMEM="18432"             # Minimum memory in megabyte
CLIENT_DESMEM="23552"             # Desired memory in megabyte
CLIENT_MAXMEM="49152"             # Maximum memory in megabyte
CLIENT_PMODE="ded"           # shared or ded
CLIENT_SMODE="keep_idle_procs"            # cap or uncap
#CLIENT_SMODE="cap"            # cap or uncap
CLIENT_SWEIGHT="128"            # Value between 0 and 255
CLIENT_MINPU="1"                # Min processing units
CLIENT_DESPU="1"                # Min virtual CPU
CLIENT_MAXPU="12"               # Max processing units 
CLIENT_MINVP="1"               # Des virtual CPU
CLIENT_DESVP="1"               # Des processing units
CLIENT_MAXVP="12"              # Max virtual CPU
CLIENT_VSLOT="200"               # Number of virtual slots
CLIENT_VETH="2/0/13//0/0,3/0/4//0/0,4/0/5//0/0"       # Virtual Ethernet adapter
...
#
#"min_proc_units=$CLIENT_MINPU","desired_proc_units=$CLIENT_DESPU","max_proc_units=$CLIENT_MAXPU",\
...
combind () {
	config=""name=$config_lpar_name","profile_name=$CLIENT_PROFILE","lpar_env=$CLIENT_ENV","min_mem=$CLIENT_MINMEM",\
"desired_mem=$CLIENT_DESMEM","max_mem=$CLIENT_MAXMEM","proc_mode=$CLIENT_PMODE","sharing_mode=$CLIENT_SMODE",\
"min_procs=$CLIENT_MINPU","desired_procs=$CLIENT_DESPU","max_procs=$CLIENT_MAXPU",\
"max_virtual_slots=$CLIENT_VSLOT","\"virtual_eth_adapters=$CLIENT_VETH\","\"virtual_fc_adapters=$config_fc\",\
"auto_start=$CLIENT_START","boot_mode=$CLIENT_BOOT","power_ctrl_lpar_ids=$CLIENT_PWR","conn_monitoring=$CLIENT_CON",\
"lpar_io_pool_ids=$CLIENT_IOPOOL""
